...
class ChairBaseMaterialController extends AbstractController
{
    public function __construct(private readonly ChairBaseMaterialService $chairBaseMaterialService)
    {
    }
